    ...
    <div className="flex flex-col items-center justify-center space-y-4">
      <div className="flex items-center gap-3">
        <div className="relative">
          {getIcon()}
          <Loader2
            className={`${sizes.spinner} text-primary absolute -top-1 -right-1 animate-spin`}
          />
        </div>
        <div className="space-y-1">
          <div className={`${sizes.text} font-medium`}>{message}</div>
          <div className={`${sizes.subText} text-muted-foreground`}>
            {subMessage}
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-col items-center justify-center space-y-6">
          <div className="flex items-center gap-4">
            <div className="relative">
              ...
              <Loader2 className="text-primary absolute -top-2 -right-2 h-6 w-6 animate-spin" />
            </div>
