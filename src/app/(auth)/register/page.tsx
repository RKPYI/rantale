...
import { Eye, EyeOff, Loader2, Mail, CheckCircle, User, Lock } from 'lucide-react';
      ...
      <div className="relative hidden h-full flex-col bg-muted p-10 text-white dark:border-r lg:flex">
        ...
        <div className="relative z-20 mt-auto">
          <blockquote className="space-y-2">
            <p className="text-lg">
              "Join thousands of readers and start your amazing reading journey with us."
            </p>
                ...
                <div className="grid gap-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className={`pl-10 pr-10 ${password !== passwordConfirmation && passwordConfirmation ? 'border-destructive focus-visible:ring-destructive' : ''}`}
                      required
                    />
                    <Button
                      type="button"
