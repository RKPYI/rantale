              ...
              ((o.nextTick = function (e) {
                ...
                if (arguments.length > 1)
                  for (var r = 1; r < arguments.length; r++)
                    t[r - 1] = arguments[r];
                (s.push(new _(e, t)), 1 !== s.length || a || u(h));
              }),
      ...
      self.fallback = async (t) => {
        let { destination: r, url: n } = t,
          o = {
            ...
            font: e.env.__PWA_FALLBACK_FONT__,
          }[r];
        return o
          ? caches.match(o, { ignoreSearch: !0 })
          : "" === r &&
              e.env.__PWA_FALLBACK_DATA__ &&
              n.match(/\/_next\/data\/.+\/.+\.json$/i)
            ? caches.match(e.env.__PWA_FALLBACK_DATA__, { ignoreSearch: !0 })
            : Response.error();
      };
    })());
})();
